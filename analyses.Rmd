...
pacman::p_load(
  ...
  # Data wrangling
  data.table, dplyr, grid, gridExtra, gtools, janitor, 
  lubridate, readxl, RODBC, tidyr, tidyverse, 
  
  # Mapping
  ggspatial, raster, rgdal, sf, sp, 
  ...
  AICcmodavg, brglm, corrplot, lme4)
```
...
nvis <- st_read(
  "input/mfws_nvis_vegetation_groups.shp", quiet = TRUE) %>%
  st_transform("EPSG:4326")
